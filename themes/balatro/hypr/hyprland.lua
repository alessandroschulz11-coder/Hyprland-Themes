...
hl.exec_cmd('mpvpaper -o "--hwdec=auto no-audio --loop" ALL ~/Videos/balatro.mp4')
hl.exec_cmd("mpv --no-video ~/Music/explosion1.ogg")
end)
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(bc413bff)", "rgba(2596beff)"}, angle = 45 },
          inactive_border = "rgba(2596beff)",
        },
